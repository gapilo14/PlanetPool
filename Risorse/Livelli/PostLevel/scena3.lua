...
-- FILENAME: scena3.lua
-- LOCATION: .\Gioco\Risorse\Livelli\PostLevel\scena3.lua
-- DESCRIZIONE: terza scena titoli di coda
--
-----------------------------------------------------------------------------------------
...
local function nextScene()
    composer.removeScene(".Risorse.Livelli.PostLevel.scena4")
    local options = {effect = "crossFade", time = 250}
	composer.gotoScene(".Risorse.Livelli.PostLevel.scena4", options)	
	return true
end
...
function scene:create(event)
    ...
    img = display.newImageRect(sceneGroup, "/Risorse/Livelli/PostLevel/SF3.png", 1920, 1080 )
end
