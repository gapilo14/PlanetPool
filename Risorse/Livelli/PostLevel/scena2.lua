...
-- FILENAME: scena2.lua
-- LOCATION: .\Gioco\Risorse\Livelli\PostLevel\scena2.lua
-- DESCRIZIONE: seconda scena titoli di coda
--
-----------------------------------------------------------------------------------------
...
local function nextScene()
    composer.removeScene(".Risorse.Livelli.PostLevel.scena3")
    local options = {effect = "crossFade", time = 250}
	composer.gotoScene(".Risorse.Livelli.PostLevel.scena3", options)	
	return true
end
...
function scene:create(event)
    ...
    img = display.newImageRect(sceneGroup, "/Risorse/Livelli/PostLevel/SF2.png", 1920, 1080 )
end
