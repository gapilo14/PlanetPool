...
-- FILENAME: level_P1L4.lua
-- LOCATION: .\.\Gioco\Risorse\Livelli\P1L4\level_P1L4.lua
-- DESCRIZIONE: pianeta 1 livello 4
--
-----------------------------------------------------------------------------------------
...
local function goToReload()
    ...
    composer.removeScene(".Risorse.Livelli.P1L4.reload")
    composer.gotoScene(".Risorse.Livelli.P1L4.reload")
    audio.stop()
...
local function winPopup()
    ...
    winScreen = display.newImageRect("/Risorse/Livelli/P1L4/Hai Vinto.png", 1920, 1080)
    winScreen.anchorX = 0
    winScreen.anchorY = 0
    winScreen.x = 0
    winScreen.y = 0
    ...
    continue = display.newImageRect("/Risorse/Livelli/P1L4/Continua.png", 388, 154)
    continue.anchorX = 0
    continue.anchorY = 0
    continue.x = 766
    continue.y = 671
...
local function wrongBall()
    -- caricamento, posizionamento e applicazione dissolvenza alla grafica per la vittoria
    loseScreen = display.newImageRect("/Risorse/Livelli/P1L4/Hai Perso.png", 1920, 1080)
    ...
    reset = display.newImageRect("/Risorse/Livelli/P1L4/Riprova.png", 388, 154)
    reset.anchorX = 0
    reset.anchorY = 0
    reset.x = 766
    reset.y = 671
...
function scene:create(event)
    ...
    mapData = json.decodeFile(system.pathForFile("Risorse/Livelli/P1L4/map_P1L4.json", system.ResourceDirectory))
...
function scene:show(event)
    ...
    elseif ( phase == "did" ) then -- se la scena è visualizzata...
        ...
        SFX_ballInHole = audio.loadSound("/Risorse/Livelli/P1L4/Palla buca.mp3")
        SFX_ballVSball = audio.loadSound("/Risorse/Livelli/P1L4/Palla contro palla.mp3")
        SFX_shore = audio.loadSound("/Risorse/Livelli/P1L4/Sponda.mp3")
        SFX_cue = audio.loadSound("/Risorse/Livelli/P1L4/Stecca.mp3")
        music = audio.loadSound("/Risorse/Livelli/P1L4/Musica.mp3")
        ...
        map = tiled.new(mapData, "Risorse/Livelli/P1L4") 
        ...
        whiteBall = display.newImageRect(sceneGroup, "/Risorse/Livelli/P1L4/Palla Bianca.png", 150, 150 )
        whiteBall.x = 659 
        whiteBall.y = 589
        whiteBall:toFront()
        ...
        blackBall = display.newImageRect(sceneGroup, "/Risorse/Livelli/P1L4/Palla Nera.png", 150, 150 )
        blackBall.x = 1520 
        blackBall.y = 360
        blackBall:toFront()
        ...
        redBall = display.newImageRect(sceneGroup, "/Risorse/Livelli/P1L4/Palla Rossa.png", 150, 150 )
        redBall.x = 1129 
        redBall.y = 479
        redBall:toFront()
        redBall.name = "red"
        ...
        cue = display.newImageRect(sceneGroup, "/Risorse/Livelli/P1L4/SteccaP1.png", 26, 721)
        cue.anchorY = 0
        cue.x = 135
        cue.y = 240
        cue:toFront()
        ...
        resetButton = display.newImageRect(sceneGroup, "/Risorse/Livelli/P1L4/Freccia Bianca.png", 88, 88) 
        resetButton.x = 1724 
        resetButton.y = 46
        resetButton:toFront() 
        ...
        homeButton = display.newImageRect(sceneGroup, "/Risorse/Livelli/P1L4/Casa.png", 88, 88)
        homeButton.x = 1844 
        homeButton.y = 46
        homeButton:toFront() 
