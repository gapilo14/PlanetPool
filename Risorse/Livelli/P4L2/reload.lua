...
-- FILENAME: reload.lua
-- LOCATION: .\Gioco\Risorse\Livelli\P4L2\reload.lua
...
local function returnToLevel()
    composer.removeScene(".Risorse.Livelli.P4L2.level_P4L2")
    local options = {effect = "crossFade", time = 100}
	composer.gotoScene(".Risorse.Livelli.P4L2.level_P4L2", options)	
	return true
end
...
function scene:create(event)
    ...
    img = display.newImageRect(sceneGroup, "/Risorse/Livelli/P4L2/Caricamento.png", 1920, 1080 )
end
