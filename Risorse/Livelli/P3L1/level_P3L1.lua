...
-- FILENAME: level_P3L1.lua
-- LOCATION: .\.\Gioco\Risorse\Livelli\P3L1\level_P3L1.lua
-- DESCRIZIONE: pianeta 3 livello 1
--
-----------------------------------------------------------------------------------------
...
local function goToReload()
    ...
    composer.removeScene(".Risorse.Livelli.P3L1.reload")
    composer.gotoScene(".Risorse.Livelli.P3L1.reload")
    audio.stop()
...
local function winPopup()
    ...
    winScreen = display.newImageRect("/Risorse/Livelli/P3L1/Hai Vinto.png", 1920, 1080)
    winScreen.anchorX = 0
    winScreen.anchorY = 0
    winScreen.x = 0
    winScreen.y = 0
    ...
    continue = display.newImageRect("/Risorse/Livelli/P3L1/Continua.png", 388, 154)
    continue.anchorX = 0
    continue.anchorY = 0
    continue.x = 766
    continue.y = 671
...
local function wrongBall()
    -- caricamento, posizionamento e applicazione dissolvenza alla grafica per la vittoria
    loseScreen = display.newImageRect("/Risorse/Livelli/P3L1/Hai Perso.png", 1920, 1080)
    ...
    reset = display.newImageRect("/Risorse/Livelli/P3L1/Riprova.png", 388, 154)
    reset.anchorX = 0
    reset.anchorY = 0
    reset.x = 766
    reset.y = 671
...
function scene:create(event)
    ...
    mapData = json.decodeFile(system.pathForFile("Risorse/Livelli/P3L1/map_P3L1.json", system.ResourceDirectory))
...
function scene:show(event)
    ...
    elseif ( phase == "did" ) then -- se la scena è visualizzata...
        ...
        SFX_ballInHole = audio.loadSound("/Risorse/Livelli/P3L1/Palla buca.mp3")
        SFX_ballVSball = audio.loadSound("/Risorse/Livelli/P3L1/Palla contro palla.mp3")
        SFX_shore = audio.loadSound("/Risorse/Livelli/P3L1/Sponda.mp3")
        SFX_cue = audio.loadSound("/Risorse/Livelli/P3L1/Stecca.mp3")
        music = audio.loadSound("/Risorse/Livelli/P3L1/Musica.mp3")
        ...
        map = tiled.new(mapData, "Risorse/Livelli/P3L1") 
        ...
        whiteBall = display.newImageRect(sceneGroup, "/Risorse/Livelli/P3L1/Palla Bianca.png", 150, 150 )
        whiteBall.x = 491
        whiteBall.y = 431
        whiteBall:toFront()
        ...
        blackBall = display.newImageRect(sceneGroup, "/Risorse/Livelli/P3L1/Palla Nera.png", 150, 150 )
        blackBall.x = 400
        blackBall.y = 839
        blackBall:toFront()
        ...
        cue = display.newImageRect(sceneGroup, "/Risorse/Livelli/P3L1/SteccaP3.png", 26, 721)
        cue.anchorY = 0
        cue.x = 135
        cue.y = 240
        cue:toFront()
        ...
        resetButton = display.newImageRect(sceneGroup, "/Risorse/Livelli/P3L1/Freccia Bianca.png", 88, 88) 
        resetButton.x = 1724 
        resetButton.y = 46
        resetButton:toFront() 
        ...
        homeButton = display.newImageRect(sceneGroup, "/Risorse/Livelli/P3L1/Casa.png", 88, 88)
        homeButton.x = 1844 
        homeButton.y = 46
        homeButton:toFront() 
