...
-- FILENAME: reload.lua
-- LOCATION: .\Gioco\Risorse\Livelli\P1L3\reload.lua
...
local function returnToLevel()
    composer.removeScene(".Risorse.Livelli.P1L3.level_P1L3")
    local options = {effect = "crossFade", time = 100}
	composer.gotoScene(".Risorse.Livelli.P1L3.level_P1L3", options)	
	return true
end
...
function scene:create(event)
    ...
    img = display.newImageRect(sceneGroup, "/Risorse/Livelli/P1L3/Caricamento.png", 1920, 1080 )
end
