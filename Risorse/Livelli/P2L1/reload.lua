...
-- FILENAME: reload.lua
-- LOCATION: .\Gioco\Risorse\Livelli\P2L1\reload.lua
...
local function returnToLevel()
    composer.removeScene(".Risorse.Livelli.P2L1.level_P2L1")
    local options = {effect = "crossFade", time = 100}
	composer.gotoScene(".Risorse.Livelli.P2L1.level_P2L1", options)	
	return true
end
...
function scene:create(event)
    ...
    img = display.newImageRect(sceneGroup, "/Risorse/Livelli/P2L1/Caricamento.png", 1920, 1080 )
end
